...
const About = () => {
  return (
    <div className="relative">
      ...
      >
        <p>With around 5 years of experience in Fullstack development, I’ve always believed in the power of technology to improve lives. My journey has taken me through roles at Dell, Boston Scientific, and several startups, where I’ve built user-focused web and mobile applications that merge clean design with seamless functionality. Whether contributing to large enterprise platforms or fast-paced startup builds, I focus on crafting intuitive, responsive experiences that deliver real value.</p>
